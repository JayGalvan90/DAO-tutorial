  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Stocks NationDAO!</h1>
          <div className={styles.description}>Welcome to the Stocks DAO!</div>
          <div className={styles.description}>
      ...
      <footer className={styles.footer}>
        Made with &#10084; by Smart Contract Developrs
      </footer>
    </div>
  );
}